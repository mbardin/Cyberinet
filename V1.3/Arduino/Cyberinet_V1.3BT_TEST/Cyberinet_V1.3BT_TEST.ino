...
void get6050() {
  ...
  Serial.print("GyroX "); // label
  Serial.println(rotX); // value

  Serial.print("GyroY "); // label
  Serial.println(rotY); // value

  Serial.print("GyroZ "); // etc.
  Serial.println(rotZ);
...
void getButtons() {
  ...
  Serial.print("B1 "); // label
  Serial.println(button1State); // value
...
void getAir() {
  ...
  Serial.print(F("AirP ")); // lebel
  Serial.println(diffPressure, 2); // value
